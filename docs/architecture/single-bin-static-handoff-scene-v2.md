...
| 初始姿态 | P02/N01 正立；P03/P04 倒立；P01/N02、W01/W02 平放 |
| 区域 | A/B/C/D 各 2 件 |
...
```mermaid
flowchart LR
    A["A 区<br/>P01 螺母 / P02 轴件"]
    B["B 区<br/>P03 P04<br/>倒立轴件"]
    C["C 区<br/>N01 轴件 / N02 螺母"]
...
|---|---|---|---:|
| S11 | P01 | nut | `(-0.1125,+0.055,0)` |
| S12 | P03 | shaft | `(-0.0375,+0.055,0)` |
| S13 | N01 | shaft | `(+0.0375,+0.055,0)` |
