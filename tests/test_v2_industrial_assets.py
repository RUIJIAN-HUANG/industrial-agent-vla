...
class V2IndustrialAssetTests(unittest.TestCase):
    ...
    def test_all_eight_asset_specs_are_program_generated_and_valid(self) -> None:
        ...
        self.assertEqual(
            summary["type_counts"], {"nut": 2, "shaft": 4, "wrench": 2}
        )
    ...
    def test_shaft_flange_makes_orientation_visible(self) -> None:
        ...
        self.assertTrue(any("orientation visible" in item for item in validate_part_spec(shaft)))
    ...
    def test_nut_requires_a_real_visible_hole(self) -> None:
        ...
        self.assertTrue(any("wall thickness" in item for item in validate_part_spec(nut)))
    ...
    def test_wrench_requires_distinct_head_and_long_handle(self) -> None:
        ...
        self.assertTrue(any("visually distinct" in item for item in validate_part_spec(wrench)))
