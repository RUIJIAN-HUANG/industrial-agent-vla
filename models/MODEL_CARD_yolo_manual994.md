...
The checkpoint file itself is not committed to this source repository because
repository policy excludes `.pt` model weights. The deployable artifact is
tracked in the model-delivery repository PR below and must match the SHA-256
digest listed here before use.
...
| Model delivery PR | `https://github.com/RUIJIAN-HUANG/industrial-agent-vla-model-yolo-manual800/pull/1` |
| Model delivery commit | `7e4c37ad01831e08d87239a26cfed65f8b3b8d99` |
| Model delivery path | `manual994/best.pt` |
