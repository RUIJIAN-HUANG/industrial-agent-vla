...
The checkpoint file itself is not committed to the main code repository
because repository policy excludes `.pt` model weights. The deployable artifact
is stored in the dedicated model artifact repository and identified by its
...
| Model artifact repository PR | `https://github.com/RUIJIAN-HUANG/industrial-agent-vla-model-yolo-manual800/pull/1` |
| Model artifact bundle | `https://github.com/RUIJIAN-HUANG/industrial-agent-vla-model-yolo-manual800/tree/codex/yolo-manual994-delivery/manual994` |
