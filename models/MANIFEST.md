...
| yolo_manual994_yolo11n_e10_cpu | YOLO11n | V2 single-bin seven-class perception candidate after 200 corrected samples | this PR | model artifact repo PR: https://github.com/RUIJIAN-HUANG/industrial-agent-vla-model-yolo-manual800/pull/1; bundle path: https://github.com/RUIJIAN-HUANG/industrial-agent-vla-model-yolo-manual800/tree/codex/yolo-manual994-delivery/manual994 | `sha256:67a70dd1f575919bde9184a993097771bbdbaa7516cdd251c1f91b2a490f1e5c` | N/A | manually cleaned V2 dataset plus 200 corrected samples | F | `CANDIDATE` |
