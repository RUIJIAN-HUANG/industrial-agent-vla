...
| EVID-YOLO-MANUAL994 | YOLO | Manual-994 YOLO checkpoint identity, held-out test metrics, class map, service config, and three-camera probe procedure | this PR | external artifact required; see `models/MODEL_CARD_yolo_manual994.md` | `sha256:67a70dd1f575919bde9184a993097771bbdbaa7516cdd251c1f91b2a490f1e5c` | `python scripts/run_yolo_three_camera_probe.py --observation-json <validated-observation.json> --output-json reports/yolo/manual994/three-camera-probe-summary.json --evidence-jsonl artifacts/detection/manual994-three-camera-probe.jsonl` | F | `PARTIAL` |
