...
| EVID-YOLO-MANUAL994 | YOLO | Manual-994 YOLO checkpoint identity, held-out test metrics, class map, service config, and three-camera probe procedure | this PR | https://github.com/RUIJIAN-HUANG/industrial-agent-vla-model-yolo-manual800/pull/1 (`manual994/best.pt` at `7e4c37ad01831e08d87239a26cfed65f8b3b8d99`) | `sha256:67a70dd1f575919bde9184a993097771bbdbaa7516cdd251c1f91b2a490f1e5c` | `python scripts/run_yolo_three_camera_probe.py --observation-json <validated-observation.json> --output-json reports/yolo/manual994/three-camera-probe-summary.json --evidence-jsonl artifacts/detection/manual994-three-camera-probe.jsonl` | F | `PARTIAL` |
